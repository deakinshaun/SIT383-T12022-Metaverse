// Unity Standard Shader for Unity 2017.1.1f1
Shader "Wrld/Stencil/StencilledGeometry"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "RenderType" = "Transparent" "Queue" = "Geometry+1" "PerformanceChecks" = "False" }
        LOD 300
        ...
        Pass
        {
            ...
            CGPROGRAM
            #pragma target 2.0
            #pragma exclude_renderers nomrt d3d11_9x

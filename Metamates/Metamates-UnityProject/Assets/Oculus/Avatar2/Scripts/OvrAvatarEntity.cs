...
#pragma warning restore 618
         ...
         *
         * You can customize entity creation by extending this class and overriding
...
#pragma warning restore 618
        ...
        /**
         * To configure creation info on an entity, extend this class and override ConfigureEntity
         *
         * If modifying _creationInfo, It is necessary to set all of the members of
        ...
        **/
        ...
        private void PerFrameRenderUpdate(float dT)
        {
            ...
            BroadcastPerFrameRenderUpdateToVisibleRenderables();
            UpdateGPUInstances();
        }

        private void BroadcastPerFrameRenderUpdateToVisibleRenderables()
        {
...
#pragma warning restore 618
        ...
        private void OnActiveRender(in CAPI.ovrAvatar2EntityRenderState renderState, in CAPI.ovrAvatar2Pose entityPose, CAPI.ovrAvatar2HierarchyVersion hierVersion)
        {
            ...
            var animatablePrimitives = UpdatePrimtivesAnimationEnabledState();

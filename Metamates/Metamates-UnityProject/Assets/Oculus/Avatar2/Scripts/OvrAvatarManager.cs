...
#pragma warning disable CS0414
        [SerializeField] private int assetVersionDefault = 3;
        [SerializeField] private int assetVersionAndroid = 3;
        [SerializeField] private int assetVersionQuest2 = 3;

        [SerializeField] private string zipPostfixDefault = "Rift";
        [SerializeField] private string zipPostfixAndroid = "Quest";
        [SerializeField] private string zipPostfixQuest2 = "Quest2";

        [SerializeField] private string zipFileExtension = ".glb";

        [SerializeField] private string streamingAssetPostfixDefault = "rift";
        [SerializeField] private string streamingAssetPostfixAndroid = "quest1";
        [SerializeField] private string streamingAssetPostfixQuest2 = "quest2";

        [SerializeField] private string streamingAssetFileExtension = ".glb.zst";
#pragma warning restore CS0414
        ...
        private string GetPlatformZipPostfix(bool sourceZipNotStreamingAsset = true)
        {
            switch (GetPlatform())
            {
                case CAPI.ovrAvatar2Platform.PC:
                    return sourceZipNotStreamingAsset ? zipPostfixDefault : streamingAssetPostfixDefault;
                case CAPI.ovrAvatar2Platform.Quest:
                    return sourceZipNotStreamingAsset ? zipPostfixAndroid : streamingAssetPostfixAndroid;
                case CAPI.ovrAvatar2Platform.Quest2:
                    return sourceZipNotStreamingAsset ? zipPostfixQuest2 : streamingAssetPostfixQuest2;
                default:

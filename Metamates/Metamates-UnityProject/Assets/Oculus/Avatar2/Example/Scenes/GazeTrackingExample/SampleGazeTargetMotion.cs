...
{
    [SerializeField] private float _magnitudeX = 0f;
    [SerializeField] private float _magnitudeY = 0f;
    [SerializeField] private float _magnitudeZ = 0f;
    
    [SerializeField] private float _speedX = 1f;
    [SerializeField] private float _speedY = 1f;
    [SerializeField] private float _speedZ = 1f;

...
public class PlacementWithMultipleDraggingDroppingController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            redButton.onClick.AddListener(() => ChangePrefabSelection("stoneWhite"));
            greenButton.onClick.AddListener(() => ChangePrefabSelection("stoneBlack"));
            blueButton.onClick.AddListener(() => ChangePrefabSelection("board"));
        }
    }
